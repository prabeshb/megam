...
/**
 * Manages "Authentication" to Megam's backend service.  The SyncAdapter framework
 ...
 */
public class MegamAuthenticator extends AbstractAccountAuthenticator {

    public MegamAuthenticator(Context context) {
        super(context);
    }
